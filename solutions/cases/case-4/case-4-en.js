(() => {
  const capacityProducts = [
    ...
    {
      code: "AN-050",
      name: "Steel angle 50×50",
      line: "line2",
      lineLabel: "Line 2"
    },
    {
      code: "AN-075",
      name: "Steel angle 75×75",
      line: "line2",
      lineLabel: "Line 2"
    },
    {
  ...
  function capacityRenderOrders() {
    ...
    capacityOrdersStatus.textContent =
      `${capacityOrders.length} orders awaiting calculation`;
  }
  ...
  function capacityPlannerUpdateSummary(
    ...
    capacityOrdersStatus.textContent =
      capacityPlanningMode === "priority"
        ...
        : `Calculated by queue • ${delayedOrders} delayed`;
  }
  ...
  capacityCalculateButton.addEventListener(
    ...
    async () => {
      ...
      setStep(
        ...
        15,
        "Analyzing orders",
        "Checking 100 production orders"
      );
      ...
      setStep(
        ...
        38,
        "Checking capacity",
        "Matching order volume against production line capacity"
      );
      ...
      setStep(
        ...
        68,
        "Building calendar",
        "Allocating workload across available production days"
      );
      ...
      setStep(
        ...
        88,
        "Checking deadlines",
        "Comparing requested and calculated completion dates"
      );
      ...
      calculationText.textContent =
        `${capacityOrders.length} orders allocated across the production calendar`;
