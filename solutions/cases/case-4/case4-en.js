const capacityProducts = [
  ...
  {
    code: "AN-050",
    name: "Steel Corner 50×50",
    line: "line2",
    lineLabel: "Line 2"
  },
  {
    code: "AN-075",
    name: "Steel Corner 75×75",
    line: "line2",
    lineLabel: "Line 2"
  },
  {
    code: "PR-040",
    name: "Steel Profile 40×40",
    line: "line3",
    lineLabel: "Line 3"
  },
  {
    code: "PR-060",
    name: "Steel Profile 60×60",
    line: "line3",
    lineLabel: "Line 3"
  }
];
...
function capacityDaysBetween(start, end) {
  const milliseconds =
    capacityCloneDate(end) -
    capacityCloneDate(start);
...
function capacityRenderOrders() {
  ...
  capacityOrdersStatus.textContent =
    `${capacityOrders.length} orders waiting for calculation`;
}
...
function capacityPlannerRenderCalendar(
  ...
  visibleDates.forEach(dateKey => {
    ...
    day.dataset.load =
      ...
      `L1: ${line1Used}/${capacityPlannerValues.line1} • ` +
      `L2: ${line2Used}/${capacityPlannerValues.line2} • ` +
      `L3: ${line3Used}/${capacityPlannerValues.line3}`;
...
function capacityPlannerUpdateSummary() {
  ...
  capacitySummaryDelayed.textContent =
    delayedOrders.toLocaleString("en-US");
  ...
  capacityOrdersStatus.textContent =
    capacityPlanningMode === "priority"
      ? `Calculated by priority • ${delayedOrders} delayed`
      : `Calculated in queue order • ${delayedOrders} delayed`;
}
...
capacityCalculateButton.addEventListener(
  ...
  () => {
    ...
    capacityOrdersStatus.textContent =
      capacityPlanningMode === "priority"
        ? "Recalculating with priority-based order rescheduling..."
        : "Sequential allocation of orders across production days...";
    ...
    setTimeout(() => {
      ...
      capacityCalculateButton.disabled =
        false;
