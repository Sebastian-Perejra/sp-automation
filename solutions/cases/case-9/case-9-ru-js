(() => {
  ...
  const customerSources = {
    crm: {
      title: "CRM",
      detail: "Поиск в базе клиентов CRM"
    },

    erp: {
      title: "ERP",
      detail: "Поиск в справочнике клиентов ERP"
    },

    "1c": {
      title: "1С",
      detail: "Поиск в справочнике контрагентов 1С"
    },

    excel: {
      title: "Excel / Sheets",
      detail: "Поиск в файле со справочником клиентов"
    }
  };
  ...
  const productSources = {
    excel: {
      ...
      detail: "Прайс-лист Excel"
    },

    erp: {
      title: "ERP Sales Catalogue",
      detail: "Каталог ERP и продажные цены"
    },

    "1c": {
      title: "1С · Номенклатура",
      detail: "Каталог номенклатуры 1С и виды цен"
    },

    crm: {
      title: "CRM Product Catalogue",
      detail: "Каталог CRM и индивидуальные цены клиентов"
    }
  };
      ...
      render: () => `
        <div class="quote-app-screen-head">
          <div>
            ...
            <small>
              Внутренняя программа для подготовки,
              проверки и отправки коммерческих предложений.
            </small>
          </div>
        ...
        <div class="quote-app-new-offer quote-app-start-card">
          ...
          <strong>
            Начните новое коммерческое предложение
          </strong>

          <p>
            На стартовом экране нет данных FreshMarket.
            Сначала менеджер сам решает,
            откуда взять запрос клиента.
          </p>
      ...
      render: () => `
        <div class="quote-app-screen-head">
          <div>
            ...
            <small>
              1 новое письмо · корпоративная почта менеджера.
            </small>
          </div>
      ...
      render: () => `
        <div class="quote-app-screen-head">
          <div>
            ...
            <small>
              ERP может быть источником клиентов,
              номенклатуры, цен и документов.
            </small>
          </div>
        ...
        <div class="quote-source-folders">
          <div>
            ...
            <small>
              18,426 клиентов · реквизиты · условия оплаты
            </small>
          </div>
      ...
      render: () => `
        <div class="quote-app-screen-head">
          <div>
            ...
            <small>
              Пример того, откуда программа
              может получать данные клиента.
            </small>
          </div>
        ...
        <div class="quote-app-screen-head">
          <div>
            ...
            <small>
              ...
              где компания может хранить прайсы и готовые PDF.
            </small>
          </div>
      ...
      render: () => `
        <div class="quote-app-screen-head">
          <div>
            ...
            <small>
              Реалистичный пример того,
              как данные могут быть разбросаны
              по локальным и сетевым папкам.
            </small>
          </div>
      ...
      render: () => `
        <div class="quote-app-screen-head">
          <div>
            ...
            <small>
              История того, что уже предлагали клиентам.
            </small>
          </div>
      ...
      render: () => `
        <div class="quote-app-screen-head">
          <div>
            ...
            <small>
              Обычный рабочий файл,
              который не является частью автоматизированного процесса.
            </small>
          </div>
        </div>
      ...
      render: () => `
        <div class="quote-app-screen-head">
          <div>
            ...
            <small>
              Именно такие файлы создают риск
              использования неактуальной цены.
            </small>
          </div>
        ...
        <div class="quote-app-new-offer">
          <span>ВНИМАНИЕ</span>
          <strong>Файл устарел</strong>

          <p>
            В управляемом процессе менеджеру не нужно угадывать,
            какой из прайсов актуален:
            источник цены определяется в самой программе.
          </p>
        </div>
      `
    },
      ...
      render: () => `
        <div class="quote-app-screen-head">
          <div>
            ...
            <small>
              Черновики старого ручного процесса.
            </small>
          </div>
        </div>
  ...
  function setDesktopStage(step) {
    if (step === 1) {
      ...
      desktopStageTitle.textContent =
        "На рабочем компьютере менеджера новое письмо";

      desktopStageDescription.textContent =
        "Нажмите на подсвеченную иконку Outlook на нижней панели, откройте новое письмо FreshMarket, прочитайте его и сверните почтовое окно.";

      desktopHintLabel.textContent =
        "НОВОЕ СООБЩЕНИЕ";

      desktopHintTitle.textContent =
        "Откройте Outlook на нижней панели";

      desktopHintText.textContent =
        "На почту только что пришёл новый запрос клиента. Начните с него.";

      desktopExplainerTitle.textContent =
        "Сначала менеджер работает с входящей почтой";

      desktopExplainerText.textContent =
        "После прочтения письма он просто сворачивает Outlook. Перед ним остаётся тот же рабочий стол, где он открывает отдельную программу «Коммерческие предложения».";
    ...
    if (step === 2) {
      ...
      desktopStageTitle.textContent =
        "Письмо прочитано. Теперь откройте программу для предложений";

      desktopStageDescription.textContent =
        "Outlook свёрнут, и перед вами остался тот же рабочий стол менеджера. Откройте «Коммерческие предложения» и создайте новое предложение.";

      desktopHintLabel.textContent =
        "СЛЕДУЮЩЕЕ ДЕЙСТВИЕ";

      desktopHintTitle.textContent =
        "Откройте «Коммерческие предложения»";

      desktopHintText.textContent =
        "Программа открывается как обычное рабочее приложение и дальше ведёт менеджера по процессу.";

      desktopExplainerTitle.textContent =
        "Почта свёрнута — рабочий стол остался перед менеджером";

      desktopExplainerText.textContent =
        "Теперь он открывает отдельную программу «Коммерческие предложения». После этого сам выбирает импорт из Outlook и нужное письмо.";
    ...
    if (step === 9) {
      ...
      desktopStageTitle.textContent =
        "Предложение сохранено. Осталось отправить письмо клиенту";

      desktopStageDescription.textContent =
        "Вернитесь в Outlook через нижнюю панель. Там уже подготовлен черновик письма с финальным PDF.";
      ...
      desktopHintText.textContent =
        "В почте уже подготовлено письмо клиенту и прикреплён сохранённый PDF.";

      desktopExplainerTitle.textContent =
        "Финальный шаг снова происходит в привычной почте";

      desktopExplainerText.textContent =
        "Менеджер открывает Outlook, проверяет готовый черновик с PDF и нажимает «Отправить».";
  ...
  function renderOpenedEmail() {
    ...
    desktopWindowBody.innerHTML = `
      ...
      <div class="quote-mail-minimize-tip">
        <span>Письмо прочитано ✓</span>

        <strong>
          Теперь сверните Outlook кнопкой «−»
    ...
    desktopWindowBody.innerHTML = `
      <div class="quote-app-screen-head">
        <div>
          ...
          <strong>Готовое письмо клиенту</strong>

          <small>
            PDF уже прикреплён из модуля
      ...
      <div class="quote-email quote-email-outgoing quote-outgoing-in-window">
        ...
        <div class="quote-email-attachment">
          ...
          <div>
            ...
            <small>
              Коммерческое предложение · сохранено в модуле
            </small>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div>
          ...
          <p>
            Запрос клиента прошёл полный путь —
            от нового письма на рабочем столе
            до сохранённого и отправленного PDF-предложения.
          </p>
    ...
    desktopWindowBody.innerHTML = `
      <div class="quote-app-screen-head">
        <div>
          ...
          <small>
            Программа ничего не подставляет сама.
            Менеджер выбирает источник запроса.
          </small>
        </div>
      ...
      <div class="quote-import-choice">
        ...
        >
          ...
          <strong>
            Импортировать запрос из email
          </strong>

          <small>
            Показать доступные письма
            из подключённой корпоративной почты.
          </small>
        </button>
        ...
        >
          ...
          <small>
            Если запрос получен по телефону,
            в мессенджере или другим способом.
          </small>
        </button>
      </div>
      ...
      <div class="quote-integration-note">
        ...
        <p>
          В этом примере программа подключена
          к корпоративному Outlook.
          Она видит только доступный менеджеру
          почтовый ящик после разрешённого подключения.
          Письмо попадёт в предложение только после того,
          как менеджер сам его выберет.
        </p>
      </div>
    `;
  }
    ...
    desktopWindowBody.innerHTML = `
      <div class="quote-app-screen-head">
        <div>
          ...
          <strong>
            Выберите письмо, из которого создать предложение
          </strong>
    ...
    desktopWindowBody.innerHTML = `
      <div class="quote-app-screen-head">
        <div>
          ...
          <strong>
            Это письмо не похоже на запрос клиента
          </strong>

          <small>
            Выберите письмо с запросом
      ...
      <div class="quote-import-warning">
        ...
        <div>
          ...
          <p>
            Письмо не содержит запроса на товары,
            количество и коммерческие условия.
          </p>
        </div>
      </div>
    ...
    desktopWindowBody.innerHTML = `
      ...
      >
        <div data-import-state="sender">
          <span>○</span>
          <strong>Определяем клиента</strong>
          <small>
            FreshMarket Distribution GmbH
          </small>
        </div>
        ...
        <div data-import-state="delivery">
          <span>○</span>
          <strong>
            Считываем адрес и дату доставки
          </strong>
          <small>
            Hamburg · 15.09.2026
          </small>
        ...
        <div data-import-state="terms">
          <span>○</span>
          <strong>
            Фиксируем дополнительные условия
          </strong>
          <small>
      ...
      >
        <div class="quote-import-result-head">
          ...
          <div>
            <strong>
              Запрос импортирован из Outlook
            </strong>

            <small>
              Теперь данные можно проверить
              и дополнить в процессе подготовки предложения.
            </small>
          </div>
        </div>
        ...
        >
          Продолжить подготовку предложения
        </button>
      </div>
    `;
  ...
  function useExistingCustomer() {
    ...
    transitionToStep(
      ...
      "Реквизиты и коммерческие условия загружены из выбранного источника."
    );
  }
  ...
  function saveNewCustomer() {
    ...
    transitionToStep(
      ...
      "Данные клиента готовы для использования в коммерческом предложении."
    );
  }
  ...
  function showBuilder() {
    ...
    transitionToStep(
      5,
      "Позиции собраны",
      "Номенклатура и базовые цены перенесены в конструктор предложения."
    );
  }
  ...
  function approvePdf() {
    ...
    transitionToStep(
      8,
      "Коммерческое предложение проверено",
      "PDF подтверждён. Теперь сохраним предложение в модуле «Коммерческие предложения».",
      1050
    );
  }
  ...
  desktop?.addEventListener(
    ...
    event => {
      ...
      if (manualButton) {
        transitionToStep(
          3,
          "Создано пустое предложение",
          "Запрос будет внесён вручную. Начинаем с идентификации клиента.",
          900
        );
      ...
      if (confirmImportButton) {
        transitionToStep(
          3,
          "Запрос импортирован из Outlook",
          "Клиент, позиции, адрес и дата считаны из выбранного письма. Теперь проверим карточку клиента.",
          1000
        );
  ...
  termsReadyButton.addEventListener(
    ...
    () => {
      transitionToStep(
        6,
        "Коммерческие условия зафиксированы",
        "Количество, цены, скидки и условия оплаты готовы. Переходим к доставке."
      );
    }
  );
  ...
  deliveryReadyButton.addEventListener(
    ...
    () => {
      ...
      transitionToStep(
        7,
        "Данные для предложения готовы",
        "Клиент, товары, цены и доставка собраны в один документ.",
        1100
      );
    }
  );
  ...
  storageReadyButton.addEventListener(
    ...
    () => {
      ...
      transitionToStep(
        9,
        "Предложение сохранено в модуле",
        "Возвращаемся на рабочий стол. В Outlook уже подготовлен черновик письма с финальным PDF.",
        1000
      );
    }
  );
