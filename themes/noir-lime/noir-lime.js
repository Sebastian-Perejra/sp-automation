...
function setupContactsOnlineCounter() {
  ...
  function pingOnlineCounter() {
    const callbackName =
      `spContactsOnline_${Date.now()}_${requestNumber++}`;
